...
class Complaint(Base):
    ...
    submitter_email: Mapped[str] = mapped_column(String(255), index=True, nullable=False)
    ...
    category: Mapped[str] = mapped_column(
        Enum("delivery", "payment", "product_quality", "wrong_order", "other", name="complaint_category"),
        default="other",
        nullable=False
    )
    ...
    messages: Mapped[list["TicketMessage"]] = relationship(back_populates="complaint", cascade="all, delete-orphan")
