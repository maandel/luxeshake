...
class SiteContent(Base):
    ...
    about_stat_1_suffix: Mapped[str] = mapped_column(
        String(50), default="%", nullable=False
    )
    about_stat_1_label: Mapped[str] = mapped_column(
        String(100), default="Natural Dairy", nullable=False
    )

    about_stat_2_value: Mapped[int] = mapped_column(default=3, nullable=False)
    about_stat_2_suffix: Mapped[str] = mapped_column(
        String(50), default=" min", nullable=False
    )
    about_stat_2_label: Mapped[str] = mapped_column(
        String(100), default="Per Batch", nullable=False
    )

    about_stat_3_value: Mapped[int] = mapped_column(default=6, nullable=False)
    about_stat_3_suffix: Mapped[str] = mapped_column(
        String(50), default="+", nullable=False
    )
    about_stat_3_label: Mapped[str] = mapped_column(
        String(100), default="Collections", nullable=False
    )
