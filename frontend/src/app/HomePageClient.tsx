...
export default function HomePageClient({ initialSiteContent }: { initialSiteContent: SiteContentData | null }) {
  const [isCartOpen, setIsCartOpen] = useState(false);
  const [siteContent, setSiteContent] = useState<SiteContentData | null>(initialSiteContent);
  const router = useRouter();
